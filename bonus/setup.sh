...
argocd app create gfranque-playground --repo http://host.k3d.internal:8080/root/test2.git --path playground/ --dest-server https://kubernetes.default.svc --dest-namespace dev --server localhost:8082 --insecure --upsert
